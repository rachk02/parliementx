...
url = "https://nass.gov.ng/mps/senators"
driver.get(url)
...
driver.find_element(By.NAME, "sen_length").click()
dropdown = driver.find_element(By.NAME, "sen_length")
dropdown.find_element(By.XPATH, "//option[. = '100']").click()
time.sleep(5)

csv_file = "nigeria_senateurs.csv"
